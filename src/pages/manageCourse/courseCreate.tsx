...
export default function CourseCreate() {
    ...
    return (
        <div className="space-y-4">
            <h2 className="text-xl font-bold mb-2 text-gray-800 dark:text-white mb-5">Create Course</h2>
                                                ...
                                                {ch.quiz.map((q, qIdx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="space-y-3 mt-2">
                                                            {/* Type Switch Tabs */}
                                                            <div className="flex space-x-2">
                                                                {(['mcq', 'yesno', 'blank'] as const).map((type) => (
                                                                    <button
                                                                        key={type}
                                                                        className={`px-3 py-1 rounded-md text-sm font-medium ${q.type === type
                                                                            ? 'bg-orange-600 text-white'
                                                                            : 'bg-orange-100 dark:bg-orange-800 text-orange-800 dark:text-white'
                                                                            }`}
                                                                        onClick={() => {
                                                                            const mods = [...course.modules];
                                                                            mods[mIdx].chapters[cIdx].quiz[qIdx].type = type;
                                                                            setCourse({ ...course, modules: mods });
                                                                        }}
                                                                    >
                                                                        {type === 'mcq' ? 'MCQ' : type === 'yesno' ? 'Yes/No' : 'Fill in the Blank'}
                                                                    </button>
                                                                ))}
                                                            </div>


                                                            <Label className="text-orange-700 dark:text-orange-100">Question</Label>
                                                            <Input
                                                                className="dark:bg-gray-900"
                                                            ...
                                                            {q.type === 'mcq' && (
                                                                <>
                                                                    <Label className="text-orange-700 dark:text-orange-100">Options</Label>
                                                                    ...
                                                                    <Label className="text-orange-700 dark:text-orange-100">Correct Answer</Label>
                                                                    <Input
                                                                        className="dark:bg-gray-900 border-2 border-green-500 ring-1 ring-green-300 dark:ring-green-700"
                                                                        placeholder="Type the correct option"
                                                                        value={q.answer}
                                                                        onChange={(e) => {
                                                                            const mods = [...course.modules];
                                                            ...
                                                            {q.type === 'blank' && (
                                                                <>
                                                                    ...
                                                                    <Input
                                                                        ...
                                                                        placeholder="Enter the blank's correct answer"
                                                                        value={q.answer}
                                                                        onChange={(e) => {
                                                                            const mods = [...course.modules];
                                                                            mods[mIdx].chapters[cIdx].quiz[qIdx].answer = e.target.value;
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        mods[mIdx].chapters.push({
                                            ...
                                            audio: "",
                                            image: "",
                                            quiz: [{ type: "mcq", question: "", options: [{ name: "" }], answer: "" }]
                                        });
                                        setCourse({ ...course, modules: mods });
                                    }}
                                >
                ...
                <section className="rounded-xl p-4 bg-slate-50 dark:bg-slate-800 text-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="border rounded-lg p-2 bg-white dark:bg-slate-700">
                            <img src={typeof course.thumbnail === "string" ? course.thumbnail : URL.createObjectURL(course.thumbnail)} alt="Thumbnail" className="rounded w-full h-[400px] object-cover" />
                        </div>
                        <div className="border rounded-lg p-2 bg-white dark:bg-slate-700">
                            <video
                                        ...
                                        <div key={j} className="ml-4 mt-3 border-t pt-2">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-5">
                                                <div className="border rounded-lg p-2 bg-white dark:bg-slate-700">
                                                    ...
                                                    <img src={typeof ch.image === "string" ? ch.image : URL.createObjectURL(ch.image)} alt="Thumbnail" className="rounded w-full h-[250px] object-cover" />
                                                </div>
                                                <div className="border rounded-lg p-2 bg-white dark:bg-slate-700">
                                                    <video
                                                        src={ch.video}
                                                ...
                                                <div className="border rounded-lg p-2 bg-white dark:bg-slate-700">
                                                    <audio controls className="mx-auto my-4 w-full">
                                                        <source src={typeof ch.audio === "string" ? ch.audio : URL.createObjectURL(ch.audio)} />
                    ...
                    <Button disabled={addLoading} onClick={handleSubmit} className="w-full mt-4">
                        Publish
                    </Button>
                </section>
            )}
